...
const Navbar = ({menu,setMenu}) => {
  ...
  return (
    <div className={`w-screen absolute z-10 xl:w-[269px] xl:static h-screen bg-[#f2f2f2] flex flex-col items-center justify-between py-6 shadow-sm duration-300 xl:translate-x-0 ${menu ? ' translate-x-0': ' -translate-x-[1500px]'} ${theme && '!bg-[#0D0B1C] text-white'}`}> 
